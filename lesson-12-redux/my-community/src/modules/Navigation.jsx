...
import FavoriteCommunitiesPage from "../pages/FavoriteCommunitiesPage/FavoriteCommunitiesPage";
...
const Navigation = () => {
  return (
    <Routes>
      ...
      <Route path="/favorite-communities" element={<FavoriteCommunitiesPage />} />
